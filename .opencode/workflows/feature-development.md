...
- Requirements defined and reviewed with stakeholders
...
3. **Security** — Assess risks (required for auth, secrets, external deps, or PII)
4. **Implementation** — Delegate to execution agents (coder, researcher, reviewer, scribe, security-auditor, sre-reviewer)
